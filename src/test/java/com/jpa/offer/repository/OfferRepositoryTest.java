...
public class OfferRepositoryTest {
    ...
    public void createOfferTest() {
        ...
        Offer offer = Offer.builder()
                .title("제안합니다")
                .content("자사 제품 판매를 제안합니다.")
                .serviceType(OfferServiceType.SNACK)
                .companyName("A회사")
                .managerName("김직원")
                .phone("010-0000-0000")
                .user(user)
    ...
    public void offerListTest(){
        ...
        Offer offer2 = Offer.builder()
                .title("제안합니다2")
                .content("자사 제품 판매를 제안합니다.")
                .serviceType(OfferServiceType.BIRTH)
                .companyName("A회사")
                .managerName("김직원")
                .phone("010-0000-0000")
                .user(user)
        ...
        // then
        Assertions.assertThat(offers.get(0).getServiceType()).isEqualTo(OfferServiceType.SNACK);
    }
    ...
    public void offerSearchTest(){
        ...
        searchCondition.setServiceType(OfferServiceType.BIRTH);
